...
- [`cross_language_contract.md`](02_architecture/cross_language_contract.md)：v1→v2 迁移表及文档、JSON、Python、MATLAB、C 和 App 迁移状态
...
- [`mode_manager_spec.md`](02_architecture/mode_manager_spec.md)：模式建议、Safety Supervisor 锁存所有权和恢复规则

## `03_validation`：探针与实验验证

- [`feasibility_probe_72h.md`](03_validation/feasibility_probe_72h.md)：探针、阶段门与降级决策
- [`experiment_protocol.md`](03_validation/experiment_protocol.md)：可复现实验、评价集解封和调参隔离规则
